...
void print_average_marks(Student *student, int Number_of_students);
...
int main()
{
    ...
    print_average_marks(S_array, Number_of_students);
    free(S_array);
    S_array = NULL;
    return 0;
}
...
void print_max_marks(Student *student, int Number_of_students)
{
    ...
    printf("studendt number [%d] have the highest marks that is %d : \n", student_number, max);
}
void print_average_marks(Student *student, int Number_of_students)
{
    int sum = 0;
